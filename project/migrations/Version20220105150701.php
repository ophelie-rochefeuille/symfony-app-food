 ...
 */
final class Version20220105150701 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande_product ADD product_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_25F1760D4584665A ON commande_product');
        $this->addSql('ALTER TABLE commande_product DROP product_id');
    }
}
